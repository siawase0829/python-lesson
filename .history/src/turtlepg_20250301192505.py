# `import turtle` is importing the Turtle graphics library in Python. This library allows you to
# create graphics and drawings using a turtle that can move around the screen.
import turtle
